// src/frontend/modules/admin/AdminLayout.jsx
// CRM-Stylized Layout wrapper injecting Sidebars, Navigations, and Outlet content.
        ...
        <div className="sidebar-footer">
          <div className="user-profile">
            ...
            <div className="user-info">
              ...
              <span className="user-email">{user?.email || "admin@system.com"}</span>
            </div>
          </div>
      ...
      <main className="main-content-area">
        <header className="top-header" style={{ justifyContent: 'flex-start' }}>
          <div className="header-actions">
            <span className="welcome-text" style={{ fontSize: '16px', fontWeight: 600 }}>Hi, Administrator</span>
          </div>
        </header>

        <div className="dashboard-view-layer">
          <Outlet />
        </div>
      </main>
    </div>
